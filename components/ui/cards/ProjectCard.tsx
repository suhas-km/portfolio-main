 ...
 * Features responsive design with alternating horizontal and vertical layouts
 */
export default function ProjectCard({
  ...
  // Determine layout based on project index (alternating layouts)
  const isVertical = index % 2 === 0; // Even indices will be vertical, odd will be horizontal
    ...
    >
      <section 
        className={`bg-white/80 border border-gray-200 dark:border-transparent rounded-lg overflow-hidden relative 
                    ...
                    dark:shadow-lg dark:shadow-blue-900/10 w-full h-[32rem]`}
        ...
        {isVertical ? (
          ...
          <div className="flex flex-col h-full">
            ...
            <div className="p-3.5 flex flex-col flex-grow">
              ...
              <p className="mt-2 text-sm leading-relaxed text-gray-600 dark:text-white/70 line-clamp-4 mb-auto">
                {description}
              </p>
